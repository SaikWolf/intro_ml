...
def main():
    ...
    ae_model = AutoEncoder_v0.load_from_checkpoint('lightning_logs/ae_fmnist/stage_3/model.ckpt')
    cls_model = Classifier_v0.load_from_checkpoint('lightning_logs/cls_fmnist/stage_3/model.ckpt')
